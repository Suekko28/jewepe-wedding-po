        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Register JeWePe WO</h4>
              <form id="formAuthentication" class="mb-3" action="{{ route('register.submit') }}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="username" name="username" placeholder="Enter your username" value="{{ Session::get('username') }}" />
                </div>
